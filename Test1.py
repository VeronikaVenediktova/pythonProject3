...
def send_message():
    ...
    result_3.config(text="MIN:" + str(var_minimum) + ", AVG:" + str(var_average) + ", LEN:" + str(
        len(list_average)) + ", CLK_RAT:" + str(click_ratio))
...
def save():
    file_dict = {}
    user_data = {}
    current_user_from_file = {}  # функция сохранения в файл
    if click_ratio >= 0.5:
        button_start.config(state="disabled")
        ...
        # text = f" {date.today()} {var_minimum} {var_average} \n"
